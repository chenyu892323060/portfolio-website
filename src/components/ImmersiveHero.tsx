  ...
  return (
    <section className="hero-section" id="top">
      <div className="hero-orbit" aria-hidden>
        <div className="shape orb orb-a" style={parallax(0.8, 0.6)} />
        <div className="shape orb orb-b" style={parallax(-0.7, 0.5)} />
        <div className="shape ring ring-a" style={parallax(-0.5, -0.4)} />
        <div className="shape ring ring-b" style={parallax(0.45, -0.35)} />
        <div className="shape capsule cap-a" style={parallax(1.1, 0.9)} />
        <div className="shape capsule cap-b" style={parallax(-1, 0.8)} />
        <div className="shape wire" style={parallax(0.35, -0.2)} />
